...
void VecPEStats::report(std::string& pe_name) {
...
void VecPEStats::ReportVec(const std::string& name)
{
...
void VecPEStats::topdown(std::string& pe_name) {
