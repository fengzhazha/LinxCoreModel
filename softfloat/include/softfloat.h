...
float4 uint64_to_float4_scalbn(uint64_t a, int, float_status *status);
float4 int64_to_float4_scalbn(int64_t a, int, float_status *status);

float4_1 uint64_to_float4_1_scalbn(uint64_t a, int, float_status *status);
float4_1 int64_to_float4_1_scalbn(int64_t a, int, float_status *status);
...
/*----------------------------------------------------------------------------
| Software low-precision conversion routines. FP4
*----------------------------------------------------------------------------*/
float4 float4_1_to_float4(float4_1, float_status *status);
float4 float8_to_float4(float8, float_status *status);
float4 float8_1_to_float4(float8_1, float_status *status);
float4 float16_to_float4(float16, float_status *status);
float4 float32_to_float4(float32, float_status *status);
float4 float64_to_float4(float64, float_status *status);
float4 bfloat16_to_float4(bfloat16, float_status *status);
float4_1 float4_to_float4_1(float4, float_status *status);
float8 float4_to_float8(float4, float_status *status);
float16 float4_to_float16(float4, float_status *status);
float32 float4_to_float32(float4, float_status *status);
float64 float4_to_float64(float4, float_status *status);
bfloat16 float4_to_bfloat16(float4, float_status *status);

int8_t  float4_to_int8_scalbn(float4, FloatRoundMode, int,
                               float_status *status);
int16_t float4_to_int16_scalbn(float4, FloatRoundMode, int, float_status *);

int8_t  float4_to_int8(float4, float_status *status);
int16_t float4_to_int16(float4, float_status *status);
int32_t float4_to_int32(float4, float_status *status);
int64_t float4_to_int64(float4, float_status *status);


uint8_t float4_to_uint8_scalbn(float4 a, FloatRoundMode,
                                int, float_status *status);
uint16_t float4_to_uint16_scalbn(float4 a, FloatRoundMode,
                                  int, float_status *status);
uint32_t float4_to_uint32_scalbn(float4 a, FloatRoundMode,
                                  int, float_status *status);
uint64_t float4_to_uint64_scalbn(float4 a, FloatRoundMode,
                                  int, float_status *status);

uint8_t  float4_to_uint8(float4 a, float_status *status);
uint16_t float4_to_uint16(float4 a, float_status *status);
uint32_t float4_to_uint32(float4 a, float_status *status);
uint64_t float4_to_uint64(float4 a, float_status *status);

/*----------------------------------------------------------------------------
| Software float4 operations.
*----------------------------------------------------------------------------*/

float4 float4_round_to_int(float4, float_status *status);
float4 float4_add(float4, float4, float_status *status);
float4 float4_sub(float4, float4, float_status *status);
float4 float4_mul(float4, float4, float_status *status);
float4 float4_muladd(float4, float4, float4, int, float_status *status);
float4 float4_div(float4, float4, float_status *status);
float4 float4_scalbn(float4, int, float_status *status);
float4 float4_min(float4, float4, float_status *status);
float4 float4_max(float4, float4, float_status *status);
float4 float4_minnum(float4, float4, float_status *status);
float4 float4_maxnum(float4, float4, float_status *status);
float4 float4_minnummag(float4, float4, float_status *status);
float4 float4_maxnummag(float4, float4, float_status *status);
float4 float4_minimum_number(float4, float4, float_status *status);
float4 float4_maximum_number(float4, float4, float_status *status);
float4 float4_sqrt(float4, float_status *status);
FloatRelation float4_compare(float4, float4, float_status *status);
FloatRelation float4_compare_quiet(float4, float4, float_status *status);

static inline float4 float4_abs(float4 a)
{
    /* Note that abs does *not* handle NaN specially, nor does
     * it flush denormal inputs to zero.
     */
    return make_float4(float4_val(a) & 0x7);
}

static inline float4 float4_chs(float4 a)
{
    /* Note that chs does *not* handle NaN specially, nor does
     * it flush denormal inputs to zero.
     */
    return make_float4(float4_val(a) ^ 0x8);
}

static inline float4 float4_set_sign(float4 a, int sign)
{
    return make_float4((float4_val(a) & 0x7) | (sign << 3));
}

static inline bool float4_eq(float4 a, float4 b, float_status *s)
{
    return float4_compare(a, b, s) == float_relation_equal;
}

static inline bool float4_le(float4 a, float4 b, float_status *s)
{
    return float4_compare(a, b, s) <= float_relation_equal;
}

static inline bool float4_lt(float4 a, float4 b, float_status *s)
{
    return float4_compare(a, b, s) < float_relation_equal;
}

static inline bool float4_ge(float4 a, float4 b, float_status *s)
{
    FloatRelation tmp = float4_compare(a, b, s);
    return  (tmp == float_relation_equal) || (tmp == float_relation_greater);
}

static inline bool float4_unordered(float4 a, float4 b, float_status *s)
{
    return float4_compare(a, b, s) == float_relation_unordered;
}

static inline bool float4_eq_quiet(float4 a, float4 b, float_status *s)
{
    return float4_compare_quiet(a, b, s) == float_relation_equal;
}

static inline bool float4_le_quiet(float4 a, float4 b, float_status *s)
{
    return float4_compare_quiet(a, b, s) <= float_relation_equal;
}

static inline bool float4_lt_quiet(float4 a, float4 b, float_status *s)
{
    return float4_compare_quiet(a, b, s) < float_relation_equal;
}

static inline bool float4_unordered_quiet(float4 a, float4 b,
                                           float_status *s)
{
    return float4_compare_quiet(a, b, s) == float_relation_unordered;
}

/*----------------------------------------------------------------------------
| Software low-precision conversion routines. FP4_1
*----------------------------------------------------------------------------*/
float4_1 float4_to_float4_1(float4, float_status *status);
float4_1 float8_to_float4_1(float8, float_status *status);
float4_1 float8_1_to_float4_1(float8_1, float_status *status);
float4_1 float16_to_float4_1(float16, float_status *status);
float4_1 float32_to_float4_1(float32, float_status *status);
float4_1 float64_to_float4_1(float64, float_status *status);
float4_1 bfloat16_to_float4_1(bfloat16, float_status *status);
float4 float4_1_to_float4(float4_1, float_status *status);
float8 float4_1_to_float8(float4_1, float_status *status);
float16 float4_1_to_float16(float4_1, float_status *status);
float32 float4_1_to_float32(float4_1, float_status *status);
float64 float4_1_to_float64(float4_1, float_status *status);
bfloat16 float4_1_to_bfloat16(float4_1, float_status *status);

int8_t  float4_1_to_int8_scalbn(float4_1, FloatRoundMode, int,
                               float_status *status);
int16_t float4_1_to_int16_scalbn(float4_1, FloatRoundMode, int, float_status *);

int8_t  float4_1_to_int8(float4_1, float_status *status);
int16_t float4_1_to_int16(float4_1, float_status *status);
int32_t float4_1_to_int32(float4_1, float_status *status);
int64_t float4_1_to_int64(float4_1, float_status *status);


uint8_t float4_1_to_uint8_scalbn(float4_1 a, FloatRoundMode,
                                int, float_status *status);
uint16_t float4_1_to_uint16_scalbn(float4_1 a, FloatRoundMode,
                                  int, float_status *status);
uint32_t float4_1_to_uint32_scalbn(float4_1 a, FloatRoundMode,
                                  int, float_status *status);
uint64_t float4_1_to_uint64_scalbn(float4_1 a, FloatRoundMode,
                                  int, float_status *status);

uint8_t  float4_1_to_uint8(float4_1 a, float_status *status);
uint16_t float4_1_to_uint16(float4_1 a, float_status *status);
uint32_t float4_1_to_uint32(float4_1 a, float_status *status);
uint64_t float4_1_to_uint64(float4_1 a, float_status *status);

/*----------------------------------------------------------------------------
| Software float4_1 operations.
*----------------------------------------------------------------------------*/

float4_1 float4_1_round_to_int(float4_1, float_status *status);
float4_1 float4_1_add(float4_1, float4_1, float_status *status);
float4_1 float4_1_sub(float4_1, float4_1, float_status *status);
float4_1 float4_1_mul(float4_1, float4_1, float_status *status);
float4_1 float4_1_muladd(float4_1, float4_1, float4_1, int, float_status *status);
float4_1 float4_1_div(float4_1, float4_1, float_status *status);
float4_1 float4_1_scalbn(float4_1, int, float_status *status);
float4_1 float4_1_min(float4_1, float4_1, float_status *status);
float4_1 float4_1_max(float4_1, float4_1, float_status *status);
float4_1 float4_1_minnum(float4_1, float4_1, float_status *status);
float4_1 float4_1_maxnum(float4_1, float4_1, float_status *status);
float4_1 float4_1_minnummag(float4_1, float4_1, float_status *status);
float4_1 float4_1_maxnummag(float4_1, float4_1, float_status *status);
float4_1 float4_1_minimum_number(float4_1, float4_1, float_status *status);
float4_1 float4_1_maximum_number(float4_1, float4_1, float_status *status);
float4_1 float4_1_sqrt(float4_1, float_status *status);
FloatRelation float4_1_compare(float4_1, float4_1, float_status *status);
FloatRelation float4_1_compare_quiet(float4_1, float4_1, float_status *status);

static inline float4_1 float4_1_abs(float4_1 a)
{
    /* Note that abs does *not* handle NaN specially, nor does
     * it flush denormal inputs to zero.
     */
    return make_float4_1(float4_1_val(a) & 0x7);
}

static inline float4_1 float4_1_chs(float4_1 a)
{
    /* Note that chs does *not* handle NaN specially, nor does
     * it flush denormal inputs to zero.
     */
    return make_float4_1(float4_1_val(a) ^ 0x8);
}

static inline float4_1 float4_1_set_sign(float4_1 a, int sign)
{
    return make_float4_1((float4_1_val(a) & 0x7) | (sign << 3));
}

static inline bool float4_1_eq(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_compare(a, b, s) == float_relation_equal;
}

static inline bool float4_1_le(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_compare(a, b, s) <= float_relation_equal;
}

static inline bool float4_1_lt(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_compare(a, b, s) < float_relation_equal;
}

static inline bool float4_1_ge(float4_1 a, float4_1 b, float_status *s)
{
    FloatRelation tmp = float4_1_compare(a, b, s);
    return  (tmp == float_relation_equal) || (tmp == float_relation_greater);
}

static inline bool float4_1_unordered(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_compare(a, b, s) == float_relation_unordered;
}

static inline bool float4_1_eq_quiet(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_compare_quiet(a, b, s) == float_relation_equal;
}

static inline bool float4_1_le_quiet(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_compare_quiet(a, b, s) <= float_relation_equal;
}

static inline bool float4_1_lt_quiet(float4_1 a, float4_1 b, float_status *s)
{
    return float4_1_compare_quiet(a, b, s) < float_relation_equal;
}

static inline bool float4_1_unordered_quiet(float4_1 a, float4_1 b,
                                           float_status *s)
{
    return float4_1_compare_quiet(a, b, s) == float_relation_unordered;
}
...
*----------------------------------------------------------------------------*/
float8 float4_to_float8(float4, float_status *status);
float8 float4_1_to_float8(float4, float_status *status);
...
float8_1 float4_to_float8_1(float4, float_status *status);
float8_1 float4_1_to_float8_1(float4_1, float_status *status);
...
uint8_t  bfloat16_to_e6m2(bfloat16, float_status *status);
...
int8_t  float4_to_int8_scalbn(float4, FloatRoundMode, int,
                               float_status *status);
int16_t float4_to_int16_scalbn(float4, FloatRoundMode, int, float_status *);
int32_t float4_to_int32_scalbn(float4, FloatRoundMode, int, float_status *);
int64_t float4_to_int64_scalbn(float4, FloatRoundMode, int, float_status *);
...
int8_t  float4_1_to_int8_scalbn(float4_1, FloatRoundMode, int,
                               float_status *status);
int16_t float4_1_to_int16_scalbn(float4_1, FloatRoundMode, int, float_status *);
int32_t float4_1_to_int32_scalbn(float4_1, FloatRoundMode, int, float_status *);
int64_t float4_1_to_int64_scalbn(float4_1, FloatRoundMode, int, float_status *);
...
static inline bool bfloat16_ge(bfloat16 a, bfloat16 b, float_status *s)
{
    FloatRelation tmp = bfloat16_compare(a, b, s);
    return  (tmp == float_relation_equal) || (tmp == float_relation_greater);
}
...
float32 float32_exp(float32, float_status *status);
float32 float32_log(float32, float_status *status);
...
float64 float64_exp(float64, float_status *status);
float64 float64_log(float64, float_status *status);
